...
import { fetchCredits, manageCredits, track_messages } from '../../common/api.action';
...
const ChatPage: React.FC<ChatPageProps> = ({ query, onNewMessage, modelType, onBack }) => {
  ...
  const transaction = await record_message_onchain({
      ai_query: response.length > 10 ? 'generated by AI' : response, 
      user_query: query,
      ai_model: modelType,
      credits: credits,
      amount: getSolFee(),
  ...
  return (
    <div className="payllm-chat-container">
      ...
      <div className="chat-messages">
       ...
       { messages[1]?.text!=="Loading" && tx && <div style={{display:'flex'}}>
